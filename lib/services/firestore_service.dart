...
class FirestoreService {
  ...
  Future<bool> createSirAccount(String username, String password) async {
    final docRef = _db.collection('teachers').doc(username);
  ...
  Future<bool> verifySirLogin(String username, String password) async {
    final doc = await _db.collection('teachers').doc(username).get();
